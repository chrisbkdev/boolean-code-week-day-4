...
function draw() {
    ...
    // for (let i = 0; i < gridMatrix.length; i++) {} forEach below does same as this loop
...
function checkLost() {
    ...
    for (let i = 0; i < currentRow.length; i++) {
     // If there is no accumulated stack below a bar element, remove the overhanging bar pieces for both the current stack and for the new bar   
...
const gameInterval = setInterval(main, 1000);
main();